...
tl.fromTo('#f4-validate-btn',
  ...
  F4 + 2.72);
tl.to('#f4-validate-btn',
  { scale: 1, backgroundColor: 'var(--peach-deep)', color: 'var(--peach-soft)',
...
function tagCard(t, cardId) {
  ...
  tl.fromTo(cardId,
    ...
    { borderColor: 'var(--peach-deep)', y: -3, duration: 0.18, ease: 'expo.out' },
    t + 0.22);
...
gsap.set('#f8-mark', { opacity: 0, scale: 0.7, y: 40, filter: 'blur(14px)', transformOrigin: '50% 50%' });
