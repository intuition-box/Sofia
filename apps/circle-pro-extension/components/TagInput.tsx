...
import { suggestFromText } from "~lib/suggest"
import { searchTaxonomy, type TaxoNode } from "~lib/taxonomyIndex"
  ...
  return (
    <div className="sis-tags">
      <div className="sis-tags-field">
        {selected.map((c) => (
          <span className="sis-tag" key={c.id} style={{ ["--c" as any]: c.color }}>
