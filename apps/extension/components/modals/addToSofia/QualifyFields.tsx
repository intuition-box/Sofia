// The qualification fields for "Add to Sofia": an editable title, ONE intention
// (the cart predicate) and taxonomy tags (the cart's contexts). Controlled.
//
...
export interface QualifyValue {
  title: string
  /** Chosen intention → the cart item's predicate. Required to submit. */
