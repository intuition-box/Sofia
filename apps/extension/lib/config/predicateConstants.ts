...
// ── Mapping: Name → ID (single source for "is this predicate pre-defined on chain?") ──

export const PREDICATE_NAME_TO_ID: Record<string, string> = buildMap([
  [PREDICATE_NAMES.FOLLOW, PREDICATE_IDS.FOLLOW],
  [PREDICATE_NAMES.TRUSTS, PREDICATE_IDS.TRUSTS],
  [PREDICATE_NAMES.DISTRUST, PREDICATE_IDS.DISTRUST],
  [PREDICATE_NAMES.VISITS_FOR_WORK, PREDICATE_IDS.VISITS_FOR_WORK],
  [PREDICATE_NAMES.VISITS_FOR_LEARNING, PREDICATE_IDS.VISITS_FOR_LEARNING],
  [PREDICATE_NAMES.VISITS_FOR_FUN, PREDICATE_IDS.VISITS_FOR_FUN],
  [PREDICATE_NAMES.VISITS_FOR_INSPIRATION, PREDICATE_IDS.VISITS_FOR_INSPIRATION],
  [PREDICATE_NAMES.VISITS_FOR_BUYING, PREDICATE_IDS.VISITS_FOR_BUYING],
  [PREDICATE_NAMES.VISITS_FOR_MUSIC, PREDICATE_IDS.VISITS_FOR_MUSIC],
  [PREDICATE_NAMES.LIKE, PREDICATE_IDS.LIKE],
  [PREDICATE_NAMES.DISLIKE, PREDICATE_IDS.DISLIKE],
  [PREDICATE_NAMES.IN_CONTEXT_OF, PREDICATE_IDS.IN_CONTEXT_OF]
])

/**
 * Returns the on-chain ID for a known predicate name, or null if the predicate
 * has no pre-defined ID and must be created on-chain on first use.
 */
