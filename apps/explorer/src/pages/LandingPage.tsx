  ...
  return (
    <div className="lp-split">
        ...
        <div className="lp-left-inner">
          ...
          <p className="lp-privy-mention">
            <svg className="lp-privy-icon" viewBox="0 0 28 28" fill="none">
              ...
              />
              <path
                d="M14 6l-7 4v8l7 4 7-4v-8l-7-4z"
      ...
      <div className="lp-right">
        ...
        {/* Tagline */}
        <h2 className="lp-right-tagline">Connect and explore your footprint</h2>
        <p className="lp-right-subtitle">
          Track your browsing intents, connect platforms, certify your
          interests, and build a verifiable reputation profile powered by the
          Intuition protocol.
        </p>
