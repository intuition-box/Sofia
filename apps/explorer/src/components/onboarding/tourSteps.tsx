...
export const TOUR_STEPS: TourStep[] = [
  {
    ...
    title: 'Explore',
    body: 'See what the community certifies — the pages, people and topics people actually trust, ranked by real signal.',
    cta: 'Open Explore',
  ...
  },
  {
    ...
    body: 'Select a topic on the donut to reveal its <b>backers</b> — the people whose trust lifted that score.',
    cta: 'Select a topic',
