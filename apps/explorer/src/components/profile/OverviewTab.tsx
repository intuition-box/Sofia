...
export default function OverviewTab({
  ...
  const categoriesByTopic = selectedTopics
    .map((topicId) => {
      ...
      const activeCategories = topic.categories.filter((c) =>
      ...
      {!hasSetup && (
        <Card className="p-8 text-center">
          ...
          <p className="text-base text-muted-foreground mt-2">
            Select your topics of interest, connect your favorite platforms, and
            build your behavioral reputation across 103 platforms.
          </p>
