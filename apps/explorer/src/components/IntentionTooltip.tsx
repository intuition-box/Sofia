...
export default function IntentionTooltip({
  termId,
  color,
  children,
}: IntentionTooltipProps) {
  ...
  return (
    ...
    >
      ...
      {open && termId && (
        <span className="absolute z-50 bottom-full left-1/2 -translate-x-1/2 mb-2 pointer-events-none it-tooltip">
          <span
