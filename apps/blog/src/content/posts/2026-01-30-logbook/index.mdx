...
title: 'Multi-wallet support & onboarding'
...
import bookmarkCollection from './bookmark-collection.png'
import multiWallet from './multiwallet.png'
import designHomeCard from './design-home-card.png'
...
<img src={multiWallet} alt="Multi-wallet selection via Privy — MetaMask, Coinbase, Rainbow, Base, Rabby" />
...
<ImageCarousel
  images={[
    ...
    { src: bookmarkCollection, alt: 'Bookmark collection' },
  ]}
/>
...
<img src={designHomeCard} alt="Redesigned claim card with trust/distrust actions and intention pills" />
