# Sofia Landing Page — Marketing Audit

## Executive Summary

The Sofia landing page has strong product fundamentals but needs sharper positioning, clearer value hierarchy, and more conversion-focused copy to compete with top-tier web3 products. Below is an actionable audit structured around the key marketing pillars.
...
- **Add a one-liner above the fold** that answers: "What is this?" in under 8 words.
  > Example: "Own your web activity. Get rewarded."
- **Remove ambiguity** — every section heading should be scannable and self-explanatory.
...
- **Show real metrics** where possible:
  - "X alpha testers"
  - "Y certifications on-chain"
  - "Z TRUST staked across the protocol"
- **Add a press/mentions bar** if any coverage exists (tweets from KOLs, articles, podcast appearances).
- **Move the Comparison table higher** — it's the strongest conversion section but buried too deep.
- **Add external testimonials** — even 1-2 alpha tester quotes would add credibility beyond the founders.
...
- **Add an email capture** for users not ready to connect a wallet. Lower barrier to entry.
- **Sticky CTA bar** at the bottom of the page on mobile — never let the user scroll without seeing an action.
...
- **Section 4:** Full-bleed screenshot showcase (one feature at a time, text + image).
- **Section 5:** Dark section with Comparison table (already done, strong).
- **Section 6:** Social proof (testimonials, metrics, press).
- **Section 7:** How it works (3 steps — already done).
- **Section 8:** Values + Vote (community engagement).
- **Section 9:** Team.
- **Section 10:** FAQ.
- **Section 11:** Final CTA — single, large, centered.
...
- **Favicon and OG image** — ensure the sharing preview (og:image) is set with a compelling visual.
...
- Ensure all images have meaningful `alt` tags (most do, good).
...
- Add a sticky bottom CTA bar on mobile.

---

## 9. COMPETITIVE EDGE — WHAT TO EMPHASIZE

Sofia's unique differentiator vs. every other web3 identity product:

> **"Your browsing history IS your identity — not a PFP, not a token, not a claim you make. It's what you actually do, verified on-chain."**

This is the core message that should be hammered home. Every section should reinforce this single idea from a different angle.
