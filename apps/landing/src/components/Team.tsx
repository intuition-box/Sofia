      ...
      <div className={styles.cardHead}>
        ...
        <div className={styles.cardMeta}>
          ...
          <div className={styles.socials}>
            <a href={`https://x.com/${member.socials.x}`} target="_blank" rel="noopener noreferrer" aria-label="X">{X_ICON}</a>
            <a href={`https://linkedin.com/in/${member.socials.linkedin}`} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">{LI_ICON}</a>
            <a href={`https://github.com/${member.socials.github}`} target="_blank" rel="noopener noreferrer" aria-label="GitHub">{GH_ICON}</a>
          </div>
        </div>
      </div>
