...
const screenshots = [
  ...
  {
    src: '/img/sofiascreen/1.png',
    alt: 'Sofia Homepage',
    title: 'Signals Details',
  },
  {
    src: '/img/sofiascreen/2.png',
    alt: 'Sofia Bookmarks',
    title: 'Signals List',
  },
  {
    src: '/img/sofiascreen/3.png',
    alt: 'Sofia Pulse',
    title: 'Add a Signals to a Bookmark',
  },
  {
    src: '/img/sofiascreen/4.png',
    alt: 'Sofia Echoes',
    title: 'Orb Tools Selection',
  },
  { src: '/img/sofiascreen/5.png', alt: 'Sofia Triples', title: 'Follow List' },
  {
    src: '/img/sofiascreen/6.png',
    alt: 'Sofia Signal',
    title: 'Sofia Analysis Result',
  },
  {
    src: '/img/sofiascreen/7.png',
    alt: 'Sofia Profile',
    title: 'Write Echoes On Chain',
  },
