...
<ImageCarousel
  images={[
    ...
    {
      src: require('./certify-onboarding-.png').default,
      alt: 'Certify onboarding',
    },
    {
      src: require('./proof-analysys-onboarding.png').default,
      alt: 'Proof analysis onboarding',
    },
    {
      src: require('./connect-your-friend-on-boarding.png').default,
      alt: 'Connect your friend onboarding',
    },
    {
      src: require('./bookmarkonboarding.png').default,
      alt: 'Bookmark onboarding',
    },
    {
      src: require('./select-bookmark-tab.png').default,
      alt: 'Select bookmark tab',
    },
  ]}
/>
