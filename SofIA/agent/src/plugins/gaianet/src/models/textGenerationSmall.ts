...
export async function textGenerationSmall(
    runtime: IAgentRuntime,
    params: GenerateTextParams
): Promise<string> {
    elizaLogger.debug("GaiaNet textGenerationSmall called");
    ...
    try {
        ...
        elizaLogger.error("GaiaNet textGenerationSmall error: " + String(error));
