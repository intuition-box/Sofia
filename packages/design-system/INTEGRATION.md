...
- tsup/tsdown is the 2026 default for _published_ libraries ([PkgPulse, 2026](https://www.pkgpulse.com/blog/tsup-vs-unbuild-vs-pkgroll-typescript-library-bundling-2026)) — overkill for internal `workspace:*`.
