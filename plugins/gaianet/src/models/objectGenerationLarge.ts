import { IAgentRuntime, ObjectGenerationParams, elizaLogger } from '@elizaos/core';
import { GaiaNetClient } from '../client';
import { getGaiaNetConfig } from '../config';

export async function objectGenerationLarge(
