...
function PopupContent() {
  ...
  const testMetaMaskConnection = async () => {
    try {
      console.log('🦊 Test connexion MetaMask...');
      ...
      console.log('📡 Réponse service worker:', response);
      
    } catch (error) {
      console.error('❌ Erreur test MetaMask:', error);
    }
  };
      ...
      <div className="border-b p-4">
        ...
        <div className="flex justify-between items-center mb-2">
          <div className="flex items-center gap-2">
            {/* Status wallet - À configurer selon vos besoins */}
          </div>
          <div className="flex items-center gap-2">
            <div
      ...
      <div className="p-4 flex-1 overflow-y-auto space-y-4">
        ...
        <Card>
          <CardHeader className="pb-2 px-4 pt-3">
            <CardTitle className="text-base">📊 Status de l'Extension</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3 px-4 pb-4">
            <div className="text-center py-2">
              <p className="text-sm text-muted-foreground mb-3">
                Extension SOFIA - Capture de données intelligente
              </p>
              <div className="text-sm text-green-600 font-medium">
                ✅ Extension active et fonctionnelle
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-2 px-4 pb-4">
            ...
            <div className="border-t pt-3">
              <p className="text-xs text-muted-foreground">
                ...
                • Capture intelligente des données<br/>
                • Stockage sécurisé avec Chrome Storage<br/>
                • Interface utilisateur moderne<br/>
                • Export de données en JSON<br/>
