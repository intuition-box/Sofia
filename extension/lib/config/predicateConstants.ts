...
export const OAUTH_PREDICATE_IDS = [
  ...
  PREDICATE_IDS.CREATED_REPO,
  PREDICATE_IDS.STARRED_REPO,
  PREDICATE_IDS.TOP_TAG,
  PREDICATE_IDS.COMPLETED_ACTIVITY
].filter(Boolean)
...
export const OAUTH_PREDICATE_LABELS: string[] = [
  ...
  PREDICATE_NAMES.CREATED_REPO,
  PREDICATE_NAMES.STARRED_REPO,
  PREDICATE_NAMES.TOP_TAG,
  PREDICATE_NAMES.COMPLETED_ACTIVITY,
  PREDICATE_NAMES.AM
].filter(Boolean)
...
export const PREDICATE_ID_TO_CERTIFICATION: Record<string, string> = buildMap([
  ...
  [PREDICATE_IDS.CREATED_REPO, PREDICATE_NAMES.CREATED_REPO],
  [PREDICATE_IDS.STARRED_REPO, PREDICATE_NAMES.STARRED_REPO],
  [PREDICATE_IDS.TOP_TAG, PREDICATE_NAMES.TOP_TAG],
  [PREDICATE_IDS.COMPLETED_ACTIVITY, PREDICATE_NAMES.COMPLETED_ACTIVITY],
